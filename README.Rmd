...
# output the results
cat('est')
result.elastic$est[c(paste0('ee.rt(ml).',1:3),
                     paste0('opt.ee(ml).',1:3),
                     paste0('elas.',1:3))]
cat('ve')
result.elastic$ve[c(paste0('ee.rt(ml).',1:3),
                     paste0('opt.ee(ml).',1:3),
                     paste0('elas.',1:3))]
cat('CI')
cbind(lower = result.elastic$CIs.inf[c(paste0('ee.rt(ml).',1:3),
                     paste0('opt.ee(ml).',1:3),
                     paste0('elas.',1:3))],
      upper = result.elastic$CIs.sup[c(paste0('ee.rt(ml).',1:3),
                     paste0('opt.ee(ml).',1:3),
                     paste0('elas.',1:3))])
