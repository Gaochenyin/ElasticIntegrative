...
```
```{r, include = FALSE}
output_function <- function(summary.res)
{
  bias <- (summary.res$est[c(paste0('AIPW.', 2:3),
                     paste0('RT.', 2:3))]-1)
  ve <- summary.res$ve[c(paste0('AIPW.', 2:3),
                     paste0('RT.', 2:3))]
  mse <- bias**2 + ve
  CP <- summary.res$CP[c(paste0('AIPW.', 2:3),
                     paste0('RT.', 2:3))]
  width <- summary.res$CI.width[c(paste0('AIPW.', 2:3),
                     paste0('RT.', 2:3))]
...
```{r echo=FALSE}
summary.res.l1 <- summary_res(elastic_aipw_ses_l1_list,
                                   psi = c(0,1,1))
summary.res.l2 <- summary_res(elastic_aipw_ses_l2_list,
                                   psi = c(0,1,1))
summary.res.l3 <- summary_res(elastic_aipw_ses_l3_list,
                                   psi = c(0,1,1))
